...
dave_seller = Seller.create!(
  name: 'Highly Legal Novelties',
  description: 'Are you a cop?',
  address: 'An alleyway near you'
)

# admin.seller << admin_seller
roy.seller << roy_seller
dave.seller << dave_seller
